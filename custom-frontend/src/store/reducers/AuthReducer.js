...
const AuthReducer = ((state = initState, action) => {
    ...
    switch (action.type) {
        case SET_TOKON_PMO:
            //console.log(user);
            decoded = verifyToken(action.paylood)
            userId = decoded.userId
            name = decoded.name
            return {
                ...state, token: action.paylood, user: { userId, name },
                pmo: true, student: false, supervisor: false
            };
        case SET_TOKON_SUPERVISOR:
            ...
            return {
                ...state, token: action.paylood, user: { userId, name },
                pmo: false, student: false, supervisor: true
            };
        case SET_TOKON_STUDENT:
            ...
            return {
                ...state, token: action.paylood, user: { userId, name },
                pmo: false, student: true, supervisor: false
            };
        case LOGOUT:
            return { ...state, token: '', user: {}, pmo: false, student: true, supervisor: false};
        default:
            return state
    }
})
